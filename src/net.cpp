...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Protect " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"protect.net", "seed.protect.net"},
    {"protect.net", "seed2.protect.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"protect.net", "testnet-seed.protect.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Protect is probably already running."), addrBind.ToString().c_str());
        else
